...
import net.alliedmods.lang.amxxpawn.action.RerunAction;
...
public class ConsoleBuilder implements Builder {
  ...
  public Process build() {
    ...
    try {
      ...
      Messages.showErrorDialog(project,
          ApBundle.message("amxx.error.compiler.process.msg", buildConfiguration, e.getMessage()),
          ApBundle.message("amxx.error.compiler.process.title"));
  ...
  private ActionToolbar createToolbar(@NotNull JComponent component) {
    ...
    toolbarActions.add(new RerunAction(console, processHandler, () -> {
