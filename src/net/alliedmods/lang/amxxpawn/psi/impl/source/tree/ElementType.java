package net.alliedmods.lang.amxxpawn.psi.impl.source.tree;
...
public interface ElementType extends ApTokenType, JavaDocTokenType {
  ...
  TokenSet AMXX_COMMENT_OR_WHITESPACE_BIT_SET = TokenSet.orSet(AMXX_WHITESPACE_BIT_SET, AMXX_COMMENT_BIT_SET);
  ...
  TokenSet AMXX_STRING_LITERAL_BIT_SET = TokenSet.create(CHARACTER_LITERAL, STRING_LITERAL);
