...
public class CreateApIncludeAction extends CreateFileFromTemplateAction implements DumbAware {

  private static final String NEW_INCLUDE = "New AMXModX Include";

  private static final String EMPTY_INCLUDE_TEMPLATE = "AMXModX Include";

  public CreateApIncludeAction() {
    super(NEW_INCLUDE, "", ApIcons.AmxxInclude16);
  }

  @Override
  protected void buildDialog(Project project, PsiDirectory psiDirectory, CreateFileFromTemplateDialog.Builder builder) {
    builder.setTitle(NEW_INCLUDE)
        .addKind("Empty Include", ApIcons.AmxxInclude16, EMPTY_INCLUDE_TEMPLATE)
